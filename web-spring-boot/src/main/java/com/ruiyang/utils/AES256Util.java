 ...
 * 功能说明：
 * 
 * AES256.java java实现AES256加密解密 依赖说明： bcprov-jdk15-133.jar：PKCS7Padding
 * javabase64-1.3.1.jar：base64 local_policy.jar 和
 * US_export_policy.jar需添加到%JAVE_HOME%\jre\lib\security中（lib中版本适合jdk1.8）
 * 
 * Original Author: deane.jia-贾亮亮,2018年5月15日下午2:41:33
 * 
 * Copyright (C)2012-2018 深圳优必选科技 All rights reserved.
 */
public class AES256Util {
	...
	// KEY种子
	private static String KEY_STR = "Z1RQ7N1A";
	// 常量
