...
public class Jobs {
	 ...
	 *  * 第一位，表示秒，取值0-59
		...
		* 
		...
		(/)斜杠：如：x/y，x是开始值，y是步长，比如在第一位（秒） 0/15就是，从0秒开始，每15秒，最后就是0，15，30，45，60    另：*(此处无空格)/y 等同于0/y

	 */
	//@Scheduled(cron="5,10,15,20,45,55 40 17 ? * 6")
	// 每周五下午 17点56分40-50秒执行
	@Scheduled(cron="40-50 56 17 ? * 5")
	public void cronJob(){
